...
type Child1EntityRepository struct {
	repository.Repository[Child1Entity]
}
...
func OneToManyChild1EntityRelation(db pg.DbClient) repository.Relation[Child1Entity] {
	return repository.Relation[Child1Entity]{
